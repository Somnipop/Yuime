...
declspec_prefix uint8_t function_name_prefix##init(const yuime_memory_functions *mem_funcs, name *array, array_size_t initial_capacity); \
/* Returns 0 if failed to allocate/reallocate. */ \
declspec_prefix uint8_t function_name_prefix##push(const yuime_memory_functions *mem_funcs, name *array, const type *value); \
declspec_prefix void function_name_prefix##free(const yuime_memory_functions *mem_funcs, name *array); \
...
declspec_prefix uint8_t function_name_prefix##reserve(const yuime_memory_functions *mem_funcs, name *array, array_size_t to_reserve); \
declspec_prefix void function_name_prefix##fit_capacity_to_size(const yuime_memory_functions *mem_funcs, name *array);
...
uint8_t function_name_prefix##init(const yuime_memory_functions *mem_funcs, name *array, array_size_t initial_capacity) { \
	array->count = 0; \
...
uint8_t function_name_prefix##push(const yuime_memory_functions *mem_funcs, name *array, const type *value) { \
...
void function_name_prefix##free(const yuime_memory_functions *mem_funcs, name *array) { \
...
uint8_t function_name_prefix##reserve(const yuime_memory_functions *mem_funcs, name *array, array_size_t to_reserve) { \
...
void function_name_prefix##fit_capacity_to_size(const yuime_memory_functions *mem_funcs, name *array) { \
