...
#define YUIME_DEFINE_ARRAY_HEADER(type, name_s, name, function_name_prefix, array_size_t, declspec_prefix) \
...
declspec_prefix uint8_t function_name_prefix##init(const yuime_mem_functions_t *mem_funcs, name *array, array_size_t initial_capacity); \
/* Returns 0 if failed to allocate/reallocate. */ \
declspec_prefix uint8_t function_name_prefix##push(const yuime_mem_functions_t *mem_funcs, name *array, const type *value); \
declspec_prefix void function_name_prefix##free(const yuime_mem_functions_t *mem_funcs, name *array); \
...
declspec_prefix uint8_t function_name_prefix##reserve(const yuime_mem_functions_t *mem_funcs, name *array, array_size_t to_reserve); \
declspec_prefix void function_name_prefix##fit_capacity_to_size(const yuime_mem_functions_t *mem_funcs, name *array);
...
void function_name_prefix##fit_capacity_to_size(const yuime_mem_functions_t *mem_funcs, name *array) { \
