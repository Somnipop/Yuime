...
typedef struct yuime_element_s {
	...
	yuime_element_event_callback_t event_callback;
 ...
 */
YUIME_API void yuime_element_init(yuime_element_t *element, yuime_element_event_callback_t event_callback, yuime_element_object self, uint8_t flags);