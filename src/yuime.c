...
// static void _yuime_set_element_children_visibility(const yuime_mem_functions_t *mem_funcs, yuime_node_pointer_array_t *children, yuime_element_pointer_array_index_t i, void *data) {
...
// void yuime_set_visibility(const yuime_mem_functions_t *mem_funcs, yuime_node_t *element, uint8_t visible) {
...
// 			yuime_node_t *parent = element->parent;
// 			while (parent != NULL) {
